...
private:
  ...
  edm::InputTag SubJetCollectionTag_;
  ...
  doGenJets_(iConfig.getUntrackedParameter<bool>("DoGenJets")) 
{
  ...
  SubJetCollectionTag_ = iConfig.getParameter<edm::InputTag>("SubJets");
...
BprimeTobH::hasJets(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  edm::Handle <PatJetCollection> subJetColl;
  iEvent.getByLabel (SubJetCollectionTag_, subJetColl);
